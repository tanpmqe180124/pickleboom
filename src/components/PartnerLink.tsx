...
const PartnerLink: React.FC = () => {
  ...
  return (
    <Link
      to="/partner"
      onClick={handleClick}
      className="group flex items-center space-x-2 rounded-lg bg-gradient-to-r from-green-600 to-emerald-600 px-4 py-2 text-white shadow-lg transition-all duration-200 hover:scale-105 hover:shadow-xl"
    >
