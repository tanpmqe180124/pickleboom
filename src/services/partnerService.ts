...
export const partnerService = {
  ...
  getCourts: async (params?: PartnerCourtParams): Promise<PartnerCourt[]> => {
    try {
      const response = await api.get('/api/Partner/courts', { params });
  ...
  getCourtById: async (id: string): Promise<PartnerCourt> => {
    try {
      const response = await api.get(`/api/Partner/courts/${id}`);
      return response.data.data || response.data;
    } catch (error) {
  ...
  createCourt: async (data: PartnerCourtRequest): Promise<string> => {
    try {
      ...
      const response = await api.post('/api/Partner/courts', formData, {
        headers: {
  ...
  updateCourt: async (id: string, data: PartnerCourtRequest): Promise<string> => {
    try {
      ...
      const response = await api.put(`/api/Partner/courts/${id}`, formData, {
        headers: {
          'Content-Type': 'multipart/form-data',
        },
      });
  ...
  deleteCourt: async (id: string): Promise<string> => {
    try {
      const response = await api.delete(`/api/Partner/courts/${id}`);
  ...
  getTimeSlots: async (courtId?: string): Promise<PartnerTimeSlot[]> => {
    try {
      ...
      const response = await api.get('/api/Partner/timeslots', { params });
      return response.data.data || response.data || [];
    } catch (error) {
  ...
  createTimeSlot: async (data: PartnerTimeSlotRequest): Promise<string> => {
    try {
      const response = await api.post('/api/Partner/timeslots', data);
  ...
  // Update time slot
  updateTimeSlot: async (id: string, data: PartnerTimeSlotRequest): Promise<string> => {
    try {
      const response = await api.put(`/api/Partner/timeslots/${id}`, data);
      return response.data.message || 'Time slot updated successfully';
    } catch (error) {
  ...
  deleteTimeSlot: async (id: string): Promise<string> => {
    try {
      const response = await api.delete(`/api/Partner/timeslots/${id}`);
  ...
  getBookings: async (params?: any): Promise<any[]> => {
    try {
      const response = await api.get('/api/Partner/bookings', { params });
      return response.data.data || response.data || [];
    } catch (error) {
  ...
  updateBookingStatus: async (id: string, status: number): Promise<string> => {
    try {
      const response = await api.put(`/api/Partner/bookings/${id}/status`, { status });
  ...
  getBlogs: async (params?: any): Promise<any[]> => {
    try {
      const response = await api.get('/api/Partner/blogs', { params });
      return response.data.data || response.data || [];
    } catch (error) {
  ...
  getBlogById: async (id: string): Promise<any> => {
    try {
      const response = await api.get(`/api/Partner/blogs/${id}`);
      return response.data.data || response.data;
    } catch (error) {
  ...
  // Create blog
  createBlog: async (data: any): Promise<string> => {
    try {
      const formData = new FormData();
      ...
      const response = await api.post('/api/Partner/blogs', formData, {
        headers: {
          'Content-Type': 'multipart/form-data',
        },
      });
  ...
  // Update blog
  updateBlog: async (id: string, data: any): Promise<string> => {
    try {
      const formData = new FormData();
      formData.append('Title', data.Title);
      formData.append('Content', data.Content);
      ...
      const response = await api.put(`/api/Partner/blogs/${id}`, formData, {
        headers: {
          'Content-Type': 'multipart/form-data',
        },
      });
  ...
  deleteBlog: async (id: string): Promise<string> => {
    try {
      const response = await api.delete(`/api/Partner/blogs/${id}`);
